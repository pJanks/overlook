...
describe('Manager', () => {
  let manager, rooms, bookings, date, currentDate, bookingDate, finalDate, newRooms, newBookings;
  ...
  it('should get the daily total revenue', () => {
    expect(manager.seeTodaysRevenue(rooms, bookings)).to.equal((429.44 + 340.17))
  })
